...
function testSRS() {
    ...
    let result = (0, srs_1.calculateSRS)(5, 0, 2.5, 0);
    ...
    result = (0, srs_1.calculateSRS)(4, 1, result.easeFactor, 1);
    ...
    result = (0, srs_1.calculateSRS)(3, prevInterval, prevEF, 2);
    ...
    result = (0, srs_1.calculateSRS)(1, 15, 2.3, 3);
